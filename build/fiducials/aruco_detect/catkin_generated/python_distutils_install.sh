...
echo_and_run cd "/home/user/catkin_ws/src/fiducials/aruco_detect"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/user/catkin_ws/src/fiducials/aruco_detect/setup.py" \
     \
    build --build-base "/home/user/catkin_ws/build/fiducials/aruco_detect" \
    install \
    --root="${DESTDIR-/}" \
